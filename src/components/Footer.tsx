    ...
    <footer className="w-full bg-gray-900/95 py-20 px-4 relative" style={{ 
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
          ...
          {/* Menu Section */}
          <div className="md:col-span-1">
            <h4 className="text-white font-medium text-lg mb-8 font-sans">Menu</h4>
          ...
          {/* Legal Section */}
          <div className="md:col-span-1">
            <h4 className="text-white font-medium text-lg mb-8 font-sans">Legal</h4>
            <nav className="space-y-5">
          ...
          <div className="md:col-span-1">
            <h4 className="text-white font-medium text-lg mb-8 font-sans">Contato</h4>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          />
            ...
            <p className="text-gray-400 text-base font-sans">
              © 2025 Mind AI Tecnologia - Todos os Direitos Reservados.
            </p>
          </div>
