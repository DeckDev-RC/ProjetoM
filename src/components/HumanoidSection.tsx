...
const HumanoidSection = () => {
  ...
  return (
    <div 
      ...
      style={{ height: '300vh' }}
    >
      <section className="w-full h-screen py-6 sm:py-10 sticky top-0 overflow-hidden bg-gray-50 dark:bg-gray-950" id="why-humanoid">
        <div className="container px-4 sm:px-6 lg:px-8 mx-auto h-full flex flex-col">
          ...
          <div className="flex items-center gap-4 mb-8 sm:mb-16 w-full">
            <div className="flex items-center gap-4">
              <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-indigo-100 dark:bg-indigo-900/50 text-indigo-600 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-700">
                <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-indigo-500 text-white mr-2">2</span>
                <span>Humanoid</span>
              </div>
            </div>
            <div className="flex-1 h-[1px] bg-indigo-300 dark:bg-indigo-700"></div>
          </div>
