...
const HowItWorks = () => {
  ...
  return (
    <section className="py-20 relative overflow-hidden" id="how-it-works" ref={sectionRef}>
      {/* Glass background overlay */}
      <div className="absolute inset-0 bg-white/5 backdrop-blur-md border border-white/10" />
      
      {/* Background decorative elements */}
      <div className="absolute -top-20 right-0 w-72 h-72 bg-pulse-50/60 rounded-full opacity-60 blur-3xl -z-10"></div>
      <div className="absolute bottom-0 left-10 w-64 h-64 bg-gray-50/70 rounded-full opacity-70 blur-3xl -z-10"></div>
